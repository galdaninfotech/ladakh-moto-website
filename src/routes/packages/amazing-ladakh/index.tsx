...
import Dates from "~/components/packages/amazing-ladakh/dates/dates";
import Itinerary from "~/components/packages/amazing-ladakh/itinerary/itinerary";
import Overview from "~/components/packages/amazing-ladakh/overview/overview";
import Cost from "~/components/packages/amazing-ladakh/cost/cost";
