...
import Dates from "~/components/ladakh-srinagar-with-umling-la/dates/dates";
import Itinerary from "~/components/ladakh-srinagar-with-umling-la/itinerary/itinerary";
import Overview from "~/components/ladakh-srinagar-with-umling-la/overview/overview";
import Cost from "~/components/ladakh-srinagar-with-umling-la/cost/cost";
