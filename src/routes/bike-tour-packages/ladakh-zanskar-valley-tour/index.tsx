...
import Itinerary from "~/components/bike-tour-packages/ladakh-zanskar-valley-tour/itinerary/itinerary";
import Overview from "~/components/bike-tour-packages/ladakh-zanskar-valley-tour/overview/overview";
import Cost from "~/components/bike-tour-packages/ladakh-zanskar-valley-tour/cost/cost";
        ...
        <div class="adventure-grid-area style-2 pt-50 pb-20">
            <div class="container">
                <div class="row">
                    <div class="col-lg-9">
                        <div class="intro">
                            <h1 id="tour-name" data-tour-name="Ladakh-Zanskar-Valley-Tour">Ladakh-Zanskar-Valley-Tour</h1>
                        </div>
