...
import Dates from "~/components/bike-tours/leh-ladakh-with-turtuk/dates/dates";
import Itinerary from "~/components/bike-tours/leh-ladakh-with-turtuk/itinerary/itinerary";
import Overview from "~/components/bike-tours/leh-ladakh-with-turtuk/overview/overview";
import Cost from "~/components/bike-tours/leh-ladakh-with-turtuk/cost/cost";
        ...
        <div class="adventure-grid-area style-2 pt-50 pb-20">
            <div class="container">
                <div class="row">
                    <div class="col-lg-9">
                        <div class="intro">
                            <h1 id="tour-name" data-tour-name="Leh Ladakh With Turtuk">Leh Ladakh With Turtuk</h1>
                        </div>
...
export const head: DocumentHead = {
  title: "Leh Ladakh With Turtuk - Bike Tour, Leh Ladakh With Turtuk | 9N/10D, 1525 km - @ ₹23,000/-",
  meta: [
    {
      name: "description",
      content: "Leh Ladakh With Turtuk | 1525 km trip on Himalayan 411 BSVI bike - Hotel, Meal, Fuel & Mechanic included | Leh Ladakh With Turtuk Bike Tour - including Manali, Leh, Khardong La, Nubra valley, Turtuk, Pangong Lake, Kargil & Srinagar. 100% Travellers Satisfaction Guaranteed.",
    },
  ],
};
