                            ...
                            <div class="accordion-body">
                                <div class="row d-block d-lg-none">
                                    ...
                                    <div class="col-12 col-lg-6 mt-3 mb-3 d-flex align-items-center justify-content-center">
                                        <ItineraryImage src="/img/bike-tours/leh-ladakh-adventure/leh-ladakh-adventure-day1.webp" alt="Day One Itinerary Image Of The leh-ladakh-adventure Bike Tour" />
                                    </div>
                                </div>
                                ...
                                <div class="row d-none d-lg-block">
                                    ...
                                    <div class="col-12 col-lg-12 mt-3 mb-3 d-flex align-items-center justify-content-center">
                                        <ItineraryImage size="desktop" src="/img/bike-tours/leh-ladakh-adventure/leh-ladakh-adventure-day1.webp" alt="Day One Itinerary Image Of The leh-ladakh-adventure Bike Tour" />
                                    </div>
                                </div>
                        ...
                        <div id="itineraryCollapse2" class="accordion-collapse collapse" data-bs-parent="#itineraryAccordion">
                            <div class="accordion-body">
                                <div class="row d-block d-lg-none">
                                    ...
                                    <div class="col-12 col-lg-6 mt-3 mb-3 d-flex align-items-center justify-content-center">
                                        <ItineraryImage src="/img/bike-tours/leh-ladakh-adventure/leh-ladakh-adventure-day2.webp" alt="Day Two Itinerary Image Of The leh-ladakh-adventure Bike Tour" />
                                    </div>
                                </div>
                                ...
                                <div class="row d-none d-lg-block">
                                    ...
                                    <div class="col-12 col-lg-12 mt-3 mb-3 d-flex align-items-center justify-content-center">
                                        <ItineraryImage size="desktop" src="/img/bike-tours/leh-ladakh-adventure/leh-ladakh-adventure-day2.webp" alt="Day Two Itinerary Image Of The leh-ladakh-adventure Bike Tour" />
                                    </div>
                                </div>
                        ...
                        <div id="itineraryCollapse3" class="accordion-collapse collapse" data-bs-parent="#itineraryAccordion">
                            <div class="accordion-body">
                                <div class="row d-block d-lg-none">
                                    ...
                                    <div class="col-12 col-lg-6 mt-3 mb-3 d-flex align-items-center justify-content-center">
                                        <ItineraryImage src="/img/bike-tours/leh-ladakh-adventure/leh-ladakh-adventure-day3.webp" alt="Day Three Itinerary Image Of The leh-ladakh-adventure Bike Tour" />
                                    </div>
                                </div>
                                ...
                                <div class="row d-none d-lg-block">
                                    ...
                                    <div class="col-12 col-lg-12 mt-3 mb-3 d-flex align-items-center justify-content-center">
                                        <ItineraryImage size="desktop" src="/img/bike-tours/leh-ladakh-adventure/leh-ladakh-adventure-day3.webp" alt="Day Three Itinerary Image Of The leh-ladakh-adventure Bike Tour" />
                                    </div>
                                </div>
                        ...
                        <div id="itineraryCollapse4" class="accordion-collapse collapse" data-bs-parent="#itineraryAccordion">
                            <div class="accordion-body">
                                <div class="row d-block d-lg-none">
                                    ...
                                    <div class="col-12 col-lg-6 mt-3 mb-3 d-flex align-items-center justify-content-center">
                                        <ItineraryImage src="/img/bike-tours/leh-ladakh-adventure/leh-ladakh-adventure-day4.webp" alt="Day Four Itinerary Image Of The leh-ladakh-adventure Bike Tour" />
                                    </div>
                                </div>
                                ...
                                <div class="row d-none d-lg-block">
                                    ...
                                    <div class="col-12 col-lg-12 mt-3 mb-3 d-flex align-items-center justify-content-center">
                                        <ItineraryImage size="desktop" src="/img/bike-tours/leh-ladakh-adventure/leh-ladakh-adventure-day4.webp" alt="Day Four Itinerary Image Of The leh-ladakh-adventure Bike Tour" />
                                    </div>
                                </div>

                                <ul class="itinerary">
                                    <li><span>Highlights</span>: Shyok River, Pangong Lake</li>
                                    <li>So, Prepare for a spectacular trip that will take you along the breathtaking and exciting route of the Shyok river to reach the exquisite Pangong Lake. The trip will take you across rough mountain landscapes and periodically tiny rural settlements of the Ladakhi people. Before long, once you have reached the lake, you will see its numerous blue waters gets refracted and scattered by sunlight. The lake is spread across of India and Tibet and ranks among the highest salt water lakes in the world.</li>
                                    <li><span>Overnight</span>: Cottage at Pangong Lake</li>
                                </ul>
                        ...
                        <div id="itineraryCollapse5" class="accordion-collapse collapse" data-bs-parent="#itineraryAccordion">
                            <div class="accordion-body">
                                <div class="row d-block d-lg-none">
                                    ...
                                    <div class="col-12 col-lg-6 mt-3 mb-3 d-flex align-items-center justify-content-center">
                                        <ItineraryImage src="/img/bike-tours/leh-ladakh-adventure/leh-ladakh-adventure-day5.webp" alt="Day Five Itinerary Image Of The leh-ladakh-adventure Bike Tour" />
                                    </div>
                                </div>
                                ...
                                <div class="row d-none d-lg-block">
                                    ...
                                    <div class="col-12 col-lg-12 mt-3 mb-3 d-flex align-items-center justify-content-center">
                                        <ItineraryImage size="desktop" src="/img/bike-tours/leh-ladakh-adventure/leh-ladakh-adventure-day5.webp" alt="Day Five Itinerary Image Of The leh-ladakh-adventure Bike Tour" />
                                    </div>
                                </div>
