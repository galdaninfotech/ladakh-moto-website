            ...
            <div class="table-responsive py-1">
                <table class="table table-bordered table-hover travel-mode">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="flex items-center justify-end" colSpan={3}><strong><span class="animated-arrow">👉</span> Solo rider private room upgrade: extra Rs 6000</strong></td>
                        </tr>
                        <tr>
                            <td class="flex items-center justify-end" colSpan={3}><strong><span class="animated-arrow">👉</span> Bike (Himalayan 452) upgrade: extra Rs 9000</strong></td>
                        </tr>
                    </tbody>
                </table>
            </div>
