        ...
        <div id="overview">
            ...
            <div class="row d-block d-lg-none">
                ...
                <div class="col-12 col-lg-6 mt-3 mb-3 d-flex align-items-center justify-content-center">
                    <ItineraryImage src="/img/bike-tours/ladakh-srinagar-with-umling-la/ladakh-srinagar-with-umling-la-overview.webp" alt="Overview Image Of The Ladakh Srinagar With Umling La Bike Tour" />
                </div>
            </div>
