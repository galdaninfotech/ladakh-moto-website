                  ...
                  <div class="carousel-inner">
                    <div class="carousel-item active">
                      ...
                      <div class="carousel-caption kb-caption kb-caption-right">
                        ...
                        <span data-animation="animated"><a href="/bike-tours/leh-ladakh-adventure" class="button-text width-6" title="More Details on Leh Ladakh Adventure Tour" aria-label="More Details on Leh Ladakh Adventure Tour">More Details</a></span>
                      </div>
                    </div>
                    ...
                    <div class="carousel-item">
                      ...
                      <div class="carousel-caption kb-caption kb-caption-right">
                        ...
                        <span data-animation="animated"><a href="/bike-tours/ladakh-with-umling-la" class="button-text width-6" title="More Details on Leh Ladakh Adventure Tour" aria-label="More Details on Leh Ladakh Adventure Tour">More Details</a></span>
                      </div>
                    </div>
                    ...
                    <div class="carousel-item">
                      ...
                      <div class="carousel-caption kb-caption kb-caption-right">
                        ...
                        <span data-animation="animated"><a href="/bike-tours/manali-leh-srinagar" class="button-text width-6" title="More Details on Leh Ladakh Adventure Tour" aria-label="More Details on Leh Ladakh Adventure Tour">More Details</a></span>
                      </div>
                    </div>
                    ...
                    <div class="carousel-item">
                      ...
                      <div class="carousel-caption kb-caption kb-caption-right">
                        ...
                        <span data-animation="animated"><a href="/bike-tours/srinagar-leh-manali" class="button-text width-6" title="More Details on Leh Ladakh Adventure Tour" aria-label="More Details on Leh Ladakh Adventure Tour">More Details</a></span>
                      </div>
                    </div>
